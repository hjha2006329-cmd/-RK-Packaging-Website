...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Our minimum order quantity starts strictly above 150 kg per size/design. This standard B2B batch scale allows us to calibrate high-speed printing and extrusion machinery to deliver the highest quality at factory rates."
  },
  {
...
export default function App() {
  ...
  const handleModalSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setModalForm({ name: '', phone: '', productType: '', quantity: 'Above 150 kg', message: '' });
      setModalSubmitted(false);
      setIsModalOpen(false);
    }, 3000);
  };

  const openInquiryModal = (productName: string = "") => {
    setModalProduct(productName);
    setModalForm(prev => ({ ...prev, productType: productName }));
    setIsModalOpen(true);
  };

  const renderPackagingSvg = (type: string, className: string = "w-full h-48") => {
    const baseSvgProps = {
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-slate-200 py-4 px-6 animate-fadeIn">
            <div className="flex flex-col gap-4">
              <a href="#about" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">About Us</a>
              <a href="#products" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">Products</a>
              <a href="#why-choose-us" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">Why Us</a>
              <a href="#industries" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">Industries We Serve</a>
              <a 
                href="#consultation" 
              ...
              <a href="#faq" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">FAQs</a>
              <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="text-slate-700 hover:text-blue-600 font-medium py-1">Contact</a>
      ...
      <section className="relative bg-gradient-to-b from-slate-50 to-white pt-10 pb-20 md:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            {/* Right Column: Interactive packaging showcases */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-900">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="space-y-3 text-xs sm:text-sm">
                ...
                <a href="mailto:rfq@rkpackaging.com" className="block text-blue-400 hover:text-blue-300 font-bold transition">
                  rfq@rkpackaging.com
                </a>
              ...
              {modalSubmitted ? (
                ...
                <form onSubmit={handleModalSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      <label className="block text-xs font-bold text-slate-700 uppercase">Estimated Quantity (MOQ: Above 150kg)</label>
                      <select 
                        value={modalForm.quantity}
                        onChange={(e) => setModalForm({...modalForm, quantity: e.target.value})}
                        className="w-full px-3 py-2.5 rounded-xl border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                        <option value="Above 150 kg">Above 150 kg (Standard MOQ)</option>
